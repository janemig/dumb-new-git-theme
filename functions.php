...
/**
 * This theme was built with PHP, Semantic HTML, CSS, love, and a Dumb New Toolbox.
 */
	...
	function custom_photoset_init() {
	  ...
	  $args = array(
	    ...
	    'show_in_menu' => true, 
	    'query_var' => true,
	    'rewrite' => array( 'slug' => _x( 'photosets', 'URL slug', 'your_text_domain' ) ),
